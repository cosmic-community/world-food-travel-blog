    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <button
              ...
              className="md:hidden p-2 text-gray-700 hover:text-accent transition-colors z-50"
      ...
      {isMobileMenuOpen && (
        <>
          ...
          {/* Mobile Menu */}
          <nav className="fixed top-[89px] left-0 right-0 bg-white border-b border-gray-200 shadow-lg z-40 md:hidden">
